...
C<use App::FetchwareX::ExtensionName> as well as a brief comment block expaining
...
of them, or at least all of the ones that your version of new() supports
setting. The values of these keys should be brief descriptions of each
...
config_options() should be used as needed to add whatever options 
